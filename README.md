1. Dragon_homepage: first ever web dev project(okay, maybe not the first ever - like everybody else i made one with taylor swift lyrics and all, but a proper one ig)
